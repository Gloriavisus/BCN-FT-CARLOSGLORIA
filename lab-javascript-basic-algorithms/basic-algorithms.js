...
NumeroLetrasParrafoTotal = parrafoTotal.length;
if( NumeroLetrasParrafoTotal.indexOf(' et ') > -1 ){
    var numeroEt = NumeroLetrasParrafoTotal.split(' et ').length;
    console.log(numeroEt);
}


//console.log(parrafoTotal);
//console.log(NumeroLetrasParrafoTotal);
